...
export function OnboardStatsRow({ data }: OnboardStatsRowProps) {
  ...
  <button className="flex items-center justify-center lg:justify-start gap-2 px-4 py-2 border border-gray-200 rounded-lg text-sm font-medium text-[#111827] hover:bg-gray-50 transition-colors w-full lg:w-auto">
    Add Member
    <ChevronDown size={16} />
  </button>
</div>
