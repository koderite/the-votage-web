    ...
    <div className="flex flex-col h-full">
      ...
      <nav className={cn(
        ...
        <NavLink href="/admin" active={isActive('/admin')}>
          <SidebarItem icon={LayoutDashboard} label="Dashboard" active={isActive('/admin')} collapsed={collapsed} />
        </NavLink>
    ...
    <>
      ...
      >
        ...
        <nav className="flex-1 overflow-y-auto py-4 px-3 space-y-1">
          <NavLink href="/admin" active={isActive('/admin')}>
            <SidebarItem icon={LayoutDashboard} label="Dashboard" active={isActive('/admin')} />
          </NavLink>
