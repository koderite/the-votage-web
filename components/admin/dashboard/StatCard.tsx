...
export function StatCard({ label, value, change, changeLabel, positive, date, index }: StatCardProps) {
  ...
  return (
    <motion.div
      ...
      className="bg-white rounded-xl p-6 shadow-[0_1px_3px_rgba(0,0,0,0.08)] hover:shadow-md transition-shadow"
    >
