      ...
      <div className="max-w-7xl mx-auto relative z-20">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 ">
          ...
          <div className="flex flex-col items-center text-center md:items-end md:text-right">
            ...
            <Button className="font-copperplate bg-white text-black hover:bg-gray-50 px-8 py-4 font-bold text-sm uppercase rounded-full ] border-2 border-black transition-all  hover:translate-y-[2px]">
              Link to Trybe
            </Button>
          </div>
        </div>
