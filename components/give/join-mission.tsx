...
export default function JoinMission() {
  return (
    <section className="w-full py-12 md:py-24 px-4 bg-white lg:px-30 lg:pt-35 lg:pb-30 ">
      <div className="max-w-7xl mx-auto">
        {/* Section Header */}
        <div className="mb-12">
          <div className="flex items-start justify-between mb-3">
            <div className="flex-1 text-center">
              <h2 className="font-display text-2xl md:text-3xl lg:text-section-heading font-black text-black leading-tight uppercase">
        ...
        <div className="grid pt-20 grid-cols-1 md:grid-cols-2 gap-8">
